...
Prioritize external-user evidence before adding scope. Candidate work includes richer import/export, formal-proof adapters, reproducible experiment manifests, accessibility improvements, and additional agent hosts. Hosted accounts, telemetry, editable UI, and built-in paid inference remain out of scope unless separately approved.

...
This release candidate includes Python wheel/source distributions, the composite GitHub Action, and an installable `rigorgraph-release` Codex marketplace ZIP containing all four skills. Stable 1.0 requires cross-platform fresh installs and an end-to-end HonestCI bundle import.
